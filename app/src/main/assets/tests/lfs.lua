...
local function lfs_tests(root_dir)
-- 	debug.sethook(function(event) print("Executed line: " .. debug.getinfo(2).currentline) end, "l")

	local tmp = root_dir
	local sep = "/"
	local upper = ".."

	local is_unix = true --package.config:sub(1,1) == "/"
