...
#define load(name, mangled)                                   \
    ...
    if(name == NULL) {                                        \
        LOGE("Failed to find symbol in lib: %s", mangled);    \
        /*return -1;*/                                        \
    }
	...
	load(lua_cpcall,
		 "_Z10lua_cpcallP9lua_StatePFiS0_EPv") // lua_cpcall(lua_State*, int (*)(lua_State*), void*)
	...
	load(lua_atpanic,
		 "_Z11lua_atpanicP9lua_StatePFiS0_E") // lua_atpanic(lua_State*, int (*)(lua_State*))
	...
	load(lua_getinfo,
		 "_Z11lua_getinfoP9lua_StatePKcP9lua_Debug") // lua_getinfo(lua_State*, char const*, lua_Debug*)
	...
	load(lua_sethook,
		 "_Z11lua_sethookP9lua_StatePFvS0_P9lua_DebugEii") // lua_sethook(lua_State*, void (*)(lua_State*, lua_Debug*), int, int)
	load(lua_getfield,
		 "_Z12lua_getfieldP9lua_StateiPKc") // lua_getfield(lua_State*, int, char const*)
	load(lua_getlocal,
		 "_Z12lua_getlocalP9lua_StatePK9lua_Debugi") // lua_getlocal(lua_State*, lua_Debug const*, int)
	load(lua_getstack,
		 "_Z12lua_getstackP9lua_StateiP9lua_Debug") // lua_getstack(lua_State*, int, lua_Debug*)
	...
	load(luaL_openlib,
		 "_Z12luaL_openlibP9lua_StatePKcPK8luaL_Regi") // luaL_openlib(lua_State*, char const*, luaL_Reg const*, int)
	load(lua_newstate,
		 "_Z12lua_newstatePFPvS_S_mmES_") // lua_newstate(void* (*)(void*, void*, unsigned long, unsigned long), void*)
	...
	load(lua_setfield,
		 "_Z12lua_setfieldP9lua_StateiPKc") // lua_setfield(lua_State*, int, char const*)
	load(lua_setlevel, "_Z12lua_setlevelP9lua_StateS0_") // lua_setlevel(lua_State*, lua_State*)
	load(lua_setlocal,
		 "_Z12lua_setlocalP9lua_StatePK9lua_Debugi") // lua_setlocal(lua_State*, lua_Debug const*, int)
	...
	load(luaL_argerror,
		 "_Z13luaL_argerrorP9lua_StateiPKc") // luaL_argerror(lua_State*, int, char const*)
	load(luaL_buffinit,
		 "_Z13luaL_buffinitP9lua_StateP11luaL_Buffer") // luaL_buffinit(lua_State*, luaL_Buffer*)
	load(luaL_callmeta,
		 "_Z13luaL_callmetaP9lua_StateiPKc") // luaL_callmeta(lua_State*, int, char const*)
	...
	load(luaL_register,
		 "_Z13luaL_registerP9lua_StatePKcPK8luaL_Reg") // luaL_register(lua_State*, char const*, luaL_Reg const*)
	load(luaL_typerror,
		 "_Z13luaL_typerrorP9lua_StateiPKc") // luaL_typerror(lua_State*, int, char const*)
	...
	load(lua_setallocf,
		 "_Z13lua_setallocfP9lua_StatePFPvS1_S1_mmES1_") // lua_setallocf(lua_State*, void* (*)(void*, void*, unsigned long, unsigned long), void*)
	...
	load(lua_tolstring,
		 "_Z13lua_tolstringP9lua_StateiPm") // lua_tolstring(lua_State*, int, unsigned long*)
	...
	load(luaL_addstring,
		 "_Z14luaL_addstringP11luaL_BufferPKc") // luaL_addstring(luaL_Buffer*, char const*)
	load(luaL_checktype, "_Z14luaL_checktypeP9lua_Stateii") // luaL_checktype(lua_State*, int, int)
	load(luaL_findtable,
		 "_Z14luaL_findtableP9lua_StateiPKci") // luaL_findtable(lua_State*, int, char const*, int)
	load(luaL_optnumber,
		 "_Z14luaL_optnumberP9lua_Stateid") // luaL_optnumber(lua_State*, int, double)
	...
	load(lua_pushstring,
		 "_Z14lua_pushstringP9lua_StatePKc") // lua_pushstring(lua_State*, char const*)
	...
	load(lua_createtable,
		 "_Z15lua_createtableP9lua_Stateii") // lua_createtable(lua_State*, int, int)
	...
	load(luaL_addlstring,
		 "_Z15luaL_addlstringP11luaL_BufferPKcm") // luaL_addlstring(luaL_Buffer*, char const*, unsigned long)
	load(luaL_checkstack,
		 "_Z15luaL_checkstackP9lua_StateiPKc") // luaL_checkstack(lua_State*, int, char const*)
	load(luaL_checkudata,
		 "_Z15luaL_checkudataP9lua_StateiPKc") // luaL_checkudata(lua_State*, int, char const*)
	load(luaL_loadbuffer,
		 "_Z15luaL_loadbufferP9lua_StatePKcmS2_") // luaL_loadbuffer(lua_State*, char const*, unsigned long, char const*)
	load(luaL_loadstring,
		 "_Z15luaL_loadstringP9lua_StatePKc") // luaL_loadstring(lua_State*, char const*)
	load(luaL_optinteger,
		 "_Z15luaL_optintegerP9lua_Stateil") // luaL_optinteger(lua_State*, int, long)
	load(luaL_optlstring,
		 "_Z15luaL_optlstringP9lua_StateiPKcPm") // luaL_optlstring(lua_State*, int, char const*, unsigned long*)
	...
	load(lua_newuserdata,
		 "_Z15lua_newuserdataP9lua_Statem") // lua_newuserdata(lua_State*, unsigned long)
	load(lua_pushboolean, "_Z15lua_pushbooleanP9lua_Statei") // lua_pushboolean(lua_State*, int)
	load(lua_pushfstring,
		 "_Z15lua_pushfstringP9lua_StatePKcz") // lua_pushfstring(lua_State*, char const*, ...)
	load(lua_pushinteger, "_Z15lua_pushintegerP9lua_Statel") // lua_pushinteger(lua_State*, long)
	load(lua_pushlstring,
		 "_Z15lua_pushlstringP9lua_StatePKcm") // lua_pushlstring(lua_State*, char const*, unsigned long)
	...
	load(luaL_checkoption,
		 "_Z16luaL_checkoptionP9lua_StateiPKcPKS2_") // luaL_checkoption(lua_State*, int, char const*, char const* const*)
	load(lua_pushcclosure,
		 "_Z16lua_pushcclosureP9lua_StatePFiS0_Ei") // lua_pushcclosure(lua_State*, int (*)(lua_State*), int)
	load(lua_pushvfstring,
		 "_Z16lua_pushvfstringP9lua_StatePKcSt9__va_list") // lua_pushvfstring(lua_State*, char const*, std::__va_list)
	load(lua_setmetatable, "_Z16lua_setmetatableP9lua_Statei") // lua_setmetatable(lua_State*, int)
	load(luaL_checkinteger,
		 "_Z17luaL_checkintegerP9lua_Statei") // luaL_checkinteger(lua_State*, int)
	load(luaL_checklstring,
		 "_Z17luaL_checklstringP9lua_StateiPm") // luaL_checklstring(lua_State*, int, unsigned long*)
	load(luaL_getmetafield,
		 "_Z17luaL_getmetafieldP9lua_StateiPKc") // luaL_getmetafield(lua_State*, int, char const*)
	load(luaL_newmetatable,
		 "_Z17luaL_newmetatableP9lua_StatePKc") // luaL_newmetatable(lua_State*, char const*)
	load(lua_pushlightuserdata,
		 "_Z21lua_pushlightuserdataP9lua_StatePv") // lua_pushlightuserdata(lua_State*, void*)
	...
	load(lua_dump,
		 "_Z8lua_dumpP9lua_StatePFiS0_PKvmPvES3_") // lua_dump(lua_State*, int (*)(lua_State*, void const*, unsigned long, void*), void*)
	load(lua_load,
		 "_Z8lua_loadP9lua_StatePFPKcS0_PvPmES3_S2_") // lua_load(lua_State*, char const* (*)(lua_State*, void*, unsigned long*), void*, char const*)
	...
	load(luaL_gsub,
		 "_Z9luaL_gsubP9lua_StatePKcS2_S2_") // luaL_gsub(lua_State*, char const*, char const*, char const*)
	...
	load(luaL_openlib,
	     "_Z12luaL_openlibP9lua_StatePKcPK8luaL_Regi") // luaL_openlib(lua_State*, char const*, luaL_Reg const*, int)
	load(lua_newstate,
	     "_Z12lua_newstatePFPvS_S_jjES_") // lua_newstate(void* (*)(void*, void*, unsigned int, unsigned int), void*)
	load(luaopen_base, "_Z12luaopen_baseP9lua_State") // luaopen_base(lua_State*)
	load(lua_rawequal, "_Z12lua_rawequalP9lua_Stateii") // lua_rawequal(lua_State*, int, int)
	load(lua_setfield,
	     "_Z12lua_setfieldP9lua_StateiPKc") // lua_setfield(lua_State*, int, char const*)
	...
	load(lua_pushvalue, "_Z13lua_pushvalueP9lua_Statei") // lua_pushvalue(lua_State*, int)
	load(lua_setallocf,
	     "_Z13lua_setallocfP9lua_StatePFPvS1_S1_jjES1_") // lua_setallocf(lua_State*, void* (*)(void*, void*, unsigned int, unsigned int), void*)
	load(lua_toboolean, "_Z13lua_tobooleanP9lua_Statei") // lua_toboolean(lua_State*, int)
	load(lua_tointeger, "_Z13lua_tointegerP9lua_Statei") // lua_tointeger(lua_State*, int)
	load(lua_tolstring,
	     "_Z13lua_tolstringP9lua_StateiPj") // lua_tolstring(lua_State*, int, unsigned int*)
	load(lua_topointer, "_Z13lua_topointerP9lua_Statei") // lua_topointer(lua_State*, int)
	load(lua_checkstack, "_Z14lua_checkstackP9lua_Statei") // lua_checkstack(lua_State*, int)
	load(lua_getupvalue, "_Z14lua_getupvalueP9lua_Stateii") // lua_getupvalue(lua_State*, int, int)
	load(lua_isuserdata, "_Z14lua_isuserdataP9lua_Statei") // lua_isuserdata(lua_State*, int)
	...
	load(lua_iscfunction, "_Z15lua_iscfunctionP9lua_Statei") // lua_iscfunction(lua_State*, int)
	load(luaL_addlstring,
	     "_Z15luaL_addlstringP11luaL_BufferPKcj") // luaL_addlstring(luaL_Buffer*, char const*, unsigned int)
	load(luaL_checkstack,
	     "_Z15luaL_checkstackP9lua_StateiPKc") // luaL_checkstack(lua_State*, int, char const*)
	load(luaL_checkudata,
	     "_Z15luaL_checkudataP9lua_StateiPKc") // luaL_checkudata(lua_State*, int, char const*)
	load(luaL_loadbuffer,
	     "_Z15luaL_loadbufferP9lua_StatePKcjS2_") // luaL_loadbuffer(lua_State*, char const*, unsigned int, char const*)
	load(luaL_loadstring,
	     "_Z15luaL_loadstringP9lua_StatePKc") // luaL_loadstring(lua_State*, char const*)
	load(luaL_optinteger,
	     "_Z15luaL_optintegerP9lua_Stateii") // luaL_optinteger(lua_State*, int, int)
	load(luaL_optlstring,
	     "_Z15luaL_optlstringP9lua_StateiPKcPj") // luaL_optlstring(lua_State*, int, char const*, unsigned int*)
	load(luaL_prepbuffer, "_Z15luaL_prepbufferP11luaL_Buffer") // luaL_prepbuffer(luaL_Buffer*)
	load(luaL_pushresult, "_Z15luaL_pushresultP11luaL_Buffer") // luaL_pushresult(luaL_Buffer*)
	load(lua_newuserdata,
	     "_Z15lua_newuserdataP9lua_Statej") // lua_newuserdata(lua_State*, unsigned int)
	load(lua_pushboolean, "_Z15lua_pushbooleanP9lua_Statei") // lua_pushboolean(lua_State*, int)
	load(lua_pushfstring,
	     "_Z15lua_pushfstringP9lua_StatePKcz") // lua_pushfstring(lua_State*, char const*, ...)
	load(lua_pushinteger, "_Z15lua_pushintegerP9lua_Statei") // lua_pushinteger(lua_State*, int)
	load(lua_pushlstring,
	     "_Z15lua_pushlstringP9lua_StatePKcj") // lua_pushlstring(lua_State*, char const*, unsigned int)
	load(lua_tocfunction, "_Z15lua_tocfunctionP9lua_Statei") // lua_tocfunction(lua_State*, int)
	load(lua_gethookcount, "_Z16lua_gethookcountP9lua_State") // lua_gethookcount(lua_State*)
	load(lua_getmetatable, "_Z16lua_getmetatableP9lua_Statei") // lua_getmetatable(lua_State*, int)
	load(luaL_checknumber, "_Z16luaL_checknumberP9lua_Statei") // luaL_checknumber(lua_State*, int)
	...
	load(luaL_checkinteger,
	     "_Z17luaL_checkintegerP9lua_Statei") // luaL_checkinteger(lua_State*, int)
	load(luaL_checklstring,
	     "_Z17luaL_checklstringP9lua_StateiPj") // luaL_checklstring(lua_State*, int, unsigned int*)
	load(luaL_getmetafield,
	     "_Z17luaL_getmetafieldP9lua_StateiPKc") // luaL_getmetafield(lua_State*, int, char const*)
	load(luaL_newmetatable,
	     "_Z17luaL_newmetatableP9lua_StatePKc") // luaL_newmetatable(lua_State*, char const*)
	...
	load(lua_call, "_Z8lua_callP9lua_Stateii") // lua_call(lua_State*, int, int)
	load(lua_dump,
	     "_Z8lua_dumpP9lua_StatePFiS0_PKvjPvES3_") // lua_dump(lua_State*, int (*)(lua_State*, void const*, unsigned int, void*), void*)
	load(lua_load,
	     "_Z8lua_loadP9lua_StatePFPKcS0_PvPjES3_S2_") // lua_load(lua_State*, char const* (*)(lua_State*, void*, unsigned int*), void*, char const*)
	load(luaL_ref, "_Z8luaL_refP9lua_Statei") // luaL_ref(lua_State*, int)
	load(lua_next, "_Z8lua_nextP9lua_Statei") // lua_next(lua_State*, int)
	load(lua_type, "_Z8lua_typeP9lua_Statei") // lua_type(lua_State*, int)
	load(lua_close, "_Z9lua_closeP9lua_State") // lua_close(lua_State*)
